...
main41 main42 main43 main44 main45 main85 main86 main87 main88 main89 main280 main28 gluinoGeneration:\
	$(PYTHIA) $$@.cc
ifeq ($(HEPMC3_USE)$(ROOT_USE),truetrue)
	$(CXX) $@.cc -o $@ $(CXX_COMMON) $(HEPMC3_INCLUDE) $(HEPMC3_LIB) $(ROOT_LIB)\
	 -DHEPMC3 `$(ROOT_CONFIG) --cflags --glibs`
